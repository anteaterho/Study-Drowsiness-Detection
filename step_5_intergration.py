...
if arduino is None:
    print("Arduino를 찾을 수 없습니다. LED 제어 없이 실행합니다.")

# 웹캠 영상 처리
cap = cv2.VideoCapture(0)
frame_counter = 0
led_state = None  # 이전 LED 상태 추적 (불필요한 시리얼 전송 방지)
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            if frame_counter >= CONSECUTIVE_FRAMES:
                cv2.putText(image, "DROWSINESS ALERT!", (30, 60),
